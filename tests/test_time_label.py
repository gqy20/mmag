...
from mmag.application import format_time_label  # noqa: E402
...
class TestFormatTimeLabel:
    ...
    def test_zero_timestamp_returns_empty(self):
        ...
        out = format_time_label(0, None)
        assert out == ""
        out = format_time_label(0, _ts(2026, 6, 14, 14, 0))
        assert out == ""
    ...
    def test_consecutive_messages_collapse_to_time_only(self):
        ...
        l1 = format_time_label(t1, None)
        l2 = format_time_label(t2, t1)
        l3 = format_time_label(t3, t2)
